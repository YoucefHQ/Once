...
const showOverlay = (websiteName, timeAgo, timeRemaining, blockedTimes, streak, timeSaved, personalizedTweet) => {
  loadFont();
...
chrome.runtime.sendMessage(
  ...
  function (response) {
    ...
    else if (response && response.showOnboarding) showOnboarding(response.websiteName);
  }
);
